...
-   **Block 3 - Down the rabbit hole**
    ...
    -   **Writing functions and iterating in R**
...
```{r out.width = "450px", echo=FALSE, fig.cap="Wisdom of the Ancients (https://xkcd.com/979/)", fig.align='center'}

knitr::include_graphics("figures/01_wisdom_of_the_ancients.png")

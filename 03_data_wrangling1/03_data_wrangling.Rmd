...
We will use this concept to our transformations. The two main functions we'll use from `tidyr` are the `pivot_longer()` to create tidy data from wide data format. 
